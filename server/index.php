...
#$time = 30;
#$taskId = 139226008;
#$workspaceId = 12337548;
#$token = '44cb0b3287b4507ed2268408c047e198c5c491e53c064c717aa1ef79819aba38';
$token = '';
...
if(isset($_POST['token'])) $token = $_POST['token']; //Are we getting a token?
...
if($success)
{
    ...
    // Get Stories (Tasks)
    if($action == "getToken"){
        $result["token"] = $client->access_token;
